...
The experience is React-based and retains the existing portfolio routing. It deliberately uses a lightweight 2D DOM world rather than introducing a new game engine, because the requested navigation layer already exists and can be improved without replacing working case-study and media flows.
