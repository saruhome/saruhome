...
export const translations = {
  en: {
    ...
    evidenceStatusPublic: "Shipped",
    evidenceStatusOngoing: "In Progress",
    evidenceStatusOngoingNote: "This project is ongoing — quantitative results aren't public yet.",
  ...
  kr: {
    ...
    evidenceStatusPublic: "완료",
    evidenceStatusOngoing: "진행 중",
    evidenceStatusOngoingNote: "진행 중인 프로젝트로 정량 성과는 공개 준비 중입니다.",
  ...
  de: {
    ...
    evidenceStatusPublic: "Abgeschlossen",
    evidenceStatusOngoing: "Laufend",
    evidenceStatusOngoingNote: "Dieses Projekt läuft noch — quantitative Ergebnisse sind noch nicht öffentlich.",
